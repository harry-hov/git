...
test_atom head contents:subject:sanitize 'Initial'
test_atom head body ''
...
test_atom tag contents:subject:sanitize 'Tagging-at-1151968727'
test_atom tag body ''
...
test_expect_success ':trim and :localpart works per email atom' '
	git for-each-ref --format="<%(authoremail:localpart)> <%(committeremail:trim)>" refs/heads >actual &&
	echo "<author> <committer@example.com>" >expect &&
...
test_atom refs/tags/multiline contents:subject:sanitize 'first-subject-line-second-subject-line'
...
test_atom refs/tags/signed-empty contents:subject:sanitize ''
...
test_atom refs/tags/signed-short contents:subject:sanitize 'subject-line'
...
test_atom refs/tags/signed-long contents:subject:sanitize 'subject-line'
